...
interface ProxyStubMaker {
    void createProxyStub(String pathElementName, String queryParameterName, StringValuePattern queryPattern, Path stubResponseBody);
}
...
public class WireMockTestUtil {
    ...
    public static WireMockServer setUp(String wireMockContextPath, boolean verbose) {
        ...
        ProxyStubMaker proxyStubMaker = (pathElementName, queryParameterName, queryPattern, stubResponseBody) ->
